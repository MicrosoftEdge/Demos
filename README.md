...
| Origin migration | Migrates an installed app to a new manifest `id` (a new path or same-site origin) without users needing to reinstall, using `migrate_to` and `migrate_from`. | [/pwa-origin-migration/](https://github.com/MicrosoftEdge/Demos/tree/main/pwa-origin-migration/) | [Origin migration](https://microsoftedge.github.io/Demos/pwa-origin-migration/) demo |
